...
int main(int argc, const char ** argv) {
    ...
    process_videos(left_filename, right_filename, video_offset, camera_params_filename, camera_intrinsics_filename, nb_stitch_workers, nb_encoding_threads, fix_exposure);
    spdlog::info("Done");
}
